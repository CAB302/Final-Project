...
public class Assets extends javax.swing.JFrame {
    ...
    private void SaveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveBtnActionPerformed
        ...
        if(AssetTb.getText().isEmpty())
        {
            ...
            startClient("save_asset"+"-"+AssetTb.getText());
    ...
    public void fetchData(){
        ...
        try {
            ...
            String sql = "SELECT rowid, name FROM asset";
    ...
    private void EditBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EditBtnActionPerformed
        ...
        startClient("edit_asset"+"-"+selected_row+"-"+AssetTb.getText());
        AssetTb.setText("");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(i >=0){
            ...
            model.removeRow(i);
            startClient("delete_asset"+"-"+selected_row);
