...
public class Users extends javax.swing.JFrame {
    ...
    private void SaveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveBtnActionPerformed
        if(accounttypetb.getText().equalsIgnoreCase("User") || accounttypetb.getText().equalsIgnoreCase("Admin")){
            if(!(usernametb.getText().isEmpty() || passtb.getText().isEmpty() || accounttypetb.getText().isEmpty() || OrganisationalTb.getText().isEmpty())) {
                ...
                String[][] databaseData;
                try{
                    Program.client.sendData(Admin.createUserMember(usernametb.getText(), passtb.getText(), OrganisationalTb.getText()));
